    ...
    class Program : NUIApplication
    {
        ...
        public void LongPanGestureTest()
        {
            ...
            orangeView.TouchEvent += (s, e) =>
            {
                ...
                longPressGestureDetector[3].FeedTouch(s as View, e.Touch);
                return true;
            };
            ...
            {
                log.AddLog($" ->yellowView OnPan {e.PanGesture.State} {isDetected}\n");
            ...
            {
                log.AddLog($" ->yellowView intercepted {isDetected}!!! {e.Touch.GetState(0)}\n");
                tempPanGestureDetector.FeedTouch(s as View, e.Touch);
                return isDetected;
            };
            yellowView.TouchEvent += (s, e) =>
            {
                log.AddLog($" ->yellowView TouchEvent!!! {e.Touch.GetState(0)} \n");
                tempPanGestureDetector.FeedTouch(s as View, e.Touch);
                return true;
            };
        }
        ...
        private bool BlueTouched(object sender, View.TouchEventArgs args)
        {
            ...
            {
                ret |= detector.FeedTouch(sender as View, args.Touch);
            }
