...
namespace Tizen.NUI.Samples
{
    public class FeedTapAndLongPressGestureSample : IExample
    {
        ...
        public void Activate()
        {
            ...
            {
                bool ret = mTapGestureDetector.FeedTouch(s as View, e.Touch);
                // ret |= mLongPressGestureDetector.FeedTouch(s as View, e.Touch);
            ...
            view1.TouchEvent += (s, e) =>
            {
                bool ret = mLongPressGestureDetector.FeedTouch(s as View, e.Touch);
