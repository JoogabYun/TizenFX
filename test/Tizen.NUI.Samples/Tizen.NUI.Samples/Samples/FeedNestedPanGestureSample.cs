...
namespace Tizen.NUI.Samples
{
    public class FeedNestedPanGestureSample : IExample
    {
        ...
        public class MyScrollView : View {
            ...
            {
                bool ret = mPanGestureDetector.FeedTouch(source as View, e.Touch);
        ...
        public View GetNewScrollView(Color color)
        {
            ...
            for (int i=0; i<20; i++)
            {
                ...
                item.TouchEvent += (s, e) =>
                {
                    bool ret = mItemTapDetector.FeedTouch(s as View, e.Touch);
                    ret |= mItemLongPressDetector.FeedTouch(s as View, e.Touch);
                    return ret;
                };
                scrollView.Add(item);
            }
